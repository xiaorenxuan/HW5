<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="book.aspx.vb" Inherits="bookView" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="BookID" 
                DataNavigateUrlFormatString="detailsView.aspx?BookID={0}" Text="View Details" />
        </Columns>
    </asp:GridView>
</asp:Content>
